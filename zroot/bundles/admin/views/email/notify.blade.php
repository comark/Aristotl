			...
			<td align="center">
				<center>
					<table border="0" width="600" cellpadding="0" cellspacing="0">
						<tr>
							<td style="color:#ffffff !important; font-size:24px; font-family: Arial, Verdana, sans-serif; padding-left:10px;" height="40">{{ Config::get('admin::config.site_title') }} - {{ $message['title'] }}</td>
						</tr>
					</table>
				</center>
			</td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
		<tr>
			<td align="center">
				...
				<h3 style="font-weight:normal; margin: 20px 0;">{{ $message['firstname'] }} {{ $message['lastname'] }}</h3>
