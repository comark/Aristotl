				<div class="row-fluid">
                  ...
                  @endif
							...
							<div class="box-content nopadding">
								<form action="{{URL::base()}}/{{Config::get('admin::config.admin_url')}}content/submit" enctype="multipart/form-data" method="POST" class='form-validate form-horizontal form-bordered' id="editcreate">
