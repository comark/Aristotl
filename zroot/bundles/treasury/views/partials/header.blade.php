				...
				<div  class="navbar ">
					...
					<div class="navbar-header">
						<ul class="header-top-left">
							<li> <a href="mailto:ps@treasury.go.ke"> <i class="flaticon-black164"></i>ps@treasury.go.ke </a> </li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="navbar-header col-md-4" >
                                            <div class="site-logo"> <a title="Logo" href="#"><img width="100%;" src="{{ URL::base() }}/treasury/assets/toplogo.png"></a> </div>
